  ...
  <el-container class="layout-container">
    <el-aside width="200px">
      ...
      <el-menu active-text-color="#ffd04b" background-color="#232323" :default-active="$route.path" text-color="#fff"
        ...
        <el-sub-menu index="/user">
          ...
          <el-menu-item index="/layout/user/profile">
            <el-icon>
              <User />
            </el-icon>
            <span>基本资料</span>
    ...
    <el-container>
      <el-header>
        <div style="flex: 1;">
          医点儿标注队：
          <strong>{{ userStore.user ? (userStore.user.nickname || userStore.user.username) : '访客' }}</strong>
        </div>
      ...
      <el-main :class="[{ 'no-background': isAvatarPage }]" class="main-content">
        <router-view></router-view>
      </el-main>
      <el-footer>医学标注系统 ©2024 Created by 医点儿标注队</el-footer>
    </el-container>
  </el-container>
</template>
